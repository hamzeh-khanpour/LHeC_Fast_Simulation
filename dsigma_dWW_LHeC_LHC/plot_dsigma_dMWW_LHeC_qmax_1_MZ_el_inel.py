...
# -------------------------------
DEFAULT_FILES = [
    "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/aaww_LHeC_iww_elastic/Events/run_01/aaww_LHeC_iww_elastic.lhe",
    "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/aaww_LHeC_iww_elastic/Events/run_02/aaww_LHeC_iww_elastic.lhe",
    "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/aaww_LHeC_iww_elastic/Events/run_03/aaww_LHeC_iww_elastic.lhe",
    "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/aaww_LHeC_INEL/Events/run_01/aaww_LHeC_INEL.lhe",
]
...
def main():
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("dsigma_dMWW_LHeC_qmax_1_MZ_el_inel.png", dpi=200)
    plt.savefig("dsigma_dMWW_LHeC_qmax_1_MZ_el_inel.pdf")
    print("Wrote dsigma_dMWW_LHeC_qmax_1_MZ_el_inel.(png|pdf)")
