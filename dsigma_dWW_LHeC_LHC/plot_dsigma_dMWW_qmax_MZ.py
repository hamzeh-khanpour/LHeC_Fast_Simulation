...
def main():
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("dsigma_dMWW_comparison_qmax_MZ.png", dpi=200)
    plt.savefig("dsigma_dMWW_comparison_qmax_MZ.pdf")
    print("Wrote dsigma_dMWW_comparison_qmax_MZ.(png|pdf)")
