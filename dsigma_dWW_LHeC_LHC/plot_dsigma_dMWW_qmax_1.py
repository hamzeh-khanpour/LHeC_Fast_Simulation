...
# -------------------------------
DEFAULT_FILES = [
    "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/aaww_LHC_iww_elastic/Events/run_03/aaww_LHC_iww_elastic.lhe",
    "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/aaww_LHC_edff_elastic/Events/run_03/aaww_LHC_edff_elastic.lhe",
    "/home/hamzeh-khanpour/MG5_aMC_v3_6_4/aaww_LHC_chff_elastic/Events/run_03/aaww_LHC_chff_elastic.lhe",
]
...
def main():
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("dsigma_dMWW_comparison_qmax_1.png", dpi=200)
    plt.savefig("dsigma_dMWW_comparison_qmax_1.pdf")
    print("Wrote dsigma_dMWW_comparison_qmax_1.(png|pdf)")
