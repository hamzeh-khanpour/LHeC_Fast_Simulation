...
# Save
full_df.to_csv("ml_input_from_histograms_FM3.csv", index=False)
print(f"✅ Saved: ml_input_from_histograms_FM3.csv with {full_df.shape[0]} events and weights for {luminosity_fb:.1f} fb^-1.")
