...
# Load dataset
df = pd.read_csv("ml_input_from_histograms_FM3.csv")
...
df_out.to_csv("ml_with_bdt_scores_FM3.csv", index=False)
print("✅ Saved: ml_with_bdt_scores_FM3.csv with BDT scores, labels, weights, and processes.")
...
plt.tight_layout()
plt.savefig("roc_curve_xgboost_FM3.pdf")
plt.show()
...
plt.tight_layout()
plt.savefig("feature_importances_xgboost_FM3.pdf")
plt.show()
