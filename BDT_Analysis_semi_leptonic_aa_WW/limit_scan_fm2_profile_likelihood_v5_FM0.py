...
# 📈 Plot q(FM2)
# ===================================
fm2_vals = np.linspace(-200.0, 200.0, 200)
...
plt.savefig("limit_scan_fm2_profile_likelihood_v5_FM0.pdf")
print("✅ Saved as 'limit_scan_fm2_profile_likelihood_v5_FM0.pdf'")
plt.show()
...
if fm2_lower and fm2_upper:
    print(f"📉 95% CL Excluded FM0 Range: {fm2_lower:.4f} to {fm2_upper:.4f} [TeV^-4]")
else:
    print("❌ No valid FM0 limits found in the scanned range.")
