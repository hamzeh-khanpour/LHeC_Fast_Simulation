...
print("✅ Saved as 'limit_scan_fm2_profile_likelihood_v5_FM3.pdf'")
plt.show()
...
if fm2_lower and fm2_upper:
    print(f"📉 95% CL Excluded FM3 Range: {fm2_lower:.4f} to {fm2_upper:.4f} [TeV^-4]")
else:
    print("❌ No valid FM3 limits found in the scanned range.")
