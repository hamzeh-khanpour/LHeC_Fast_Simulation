...
signal_file_0 = "/home/hamzeh-khanpour/MG5_aMC_v3_5_7/aa_ww_fully_leptonic_NP_1_FM0_LHC/Events/run_01/aa_ww_fully_leptonic_NP_1_FM0_LHC.lhe"
signal_file_2 = "/home/hamzeh-khanpour/MG5_aMC_v3_5_7/aa_ww_fully_leptonic_NP_1_FM2_LHC/Events/run_01/aa_ww_fully_leptonic_NP_1_FM2_LHC.lhe"

background_file = "/home/hamzeh-khanpour/MG5_aMC_v3_5_7/aa_ww_fully_leptonic_SM_LHC/Events/run_01/aa_ww_fully_leptonic_SM_LHC.lhe"
...
plt.step(pt_bins_signal_0, dsigma_signal_pt_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($w^+ w^-) [f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(pt_bins_signal_2, dsigma_signal_pt_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(pt_bins_background, dsigma_background_pt, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
plt.xlabel(r"$p_T^{\ell} \ \mathrm{[GeV]}$")
plt.ylabel(r"$\frac{d\sigma}{dp_T^{\ell}} \ \mathrm{[pb/GeV]}$")
plt.title(r"$p p \to p W^+ W^- p \to p \ell^+ \nu_{\ell} \ell^- \bar{\nu}_{\ell} p$ : LHC@13 TeV", fontsize=24)
plt.yscale("log")
plt.legend()
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plt.ylim(0.00001, 0.001)
plt.savefig("differential_cross_section_pt_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(eta_bins_signal_0, dsigma_signal_eta_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($w^+ w^-) [f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(eta_bins_signal_2, dsigma_signal_eta_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(eta_bins_background, dsigma_background_eta, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plt.savefig("differential_cross_section_eta_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(delta_r_bins_signal_0, dsigma_signal_delta_r_0, where="mid", alpha=0.7, label=r"LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(delta_r_bins_signal_2, dsigma_signal_delta_r_2, where="mid", alpha=0.7, label=r"LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(delta_r_bins_background, dsigma_background_delta_r, where="mid", alpha=0.7, label=r"LHC@13 TeV : SM background ($W^+ W^-$)", color="blue", linewidth=3)
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plt.savefig("differential_cross_section_delta_r_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(met_bins_signal_0, dsigma_signal_met_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($w^+ w^-) [f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(met_bins_signal_2, dsigma_signal_met_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($w^+ w^-) [f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(met_bins_background, dsigma_background_met, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($w^+ w^-$)", color="blue", linewidth=3)
...
plt.savefig("differential_cross_section_met_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(rapidity_bins_signal_0, dsigma_signal_rapidity_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(rapidity_bins_signal_2, dsigma_signal_rapidity_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(rapidity_bins_background, dsigma_background_rapidity, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($W^+ W^-$)", color="blue", linewidth=3)
...
plt.tight_layout()
plt.ylim(0.0001, 1.0)
plt.savefig("differential_cross_section_rapidity_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(m_ll_bins_signal_0, dsigma_signal_m_ll_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(m_ll_bins_signal_2, dsigma_signal_m_ll_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(m_ll_bins_background, dsigma_background_m_ll, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($W^+ W^-$)", color="blue", linewidth=3)
...
plt.savefig("differential_cross_section_m_ll_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(pt_ll_bins_signal_0, dsigma_signal_pt_ll_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(pt_ll_bins_signal_2, dsigma_signal_pt_ll_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(pt_ll_bins_background, dsigma_background_pt_ll, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($W^+ W^-$)", color="blue", linewidth=3)
...
plt.tight_layout()
plt.ylim(0.00001, 0.001)
plt.savefig("differential_cross_section_pt_ll_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(pt_lepton_1_bins_signal_0, dsigma_signal_pt_lepton_1_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(pt_lepton_1_bins_signal_2, dsigma_signal_pt_lepton_1_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(pt_lepton_1_bins_background, dsigma_background_pt_lepton_1, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($W^+ W^-$)", color="blue", linewidth=3)
...
plt.tight_layout()
plt.ylim(0.00001, 0.001)
plt.savefig("differential_cross_section_pt_lepton_1_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(pt_lepton_2_bins_signal_0, dsigma_signal_pt_lepton_2_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(pt_lepton_2_bins_signal_2, dsigma_signal_pt_lepton_2_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(pt_lepton_2_bins_background, dsigma_background_pt_lepton_2, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($W^+ W^-$)", color="blue", linewidth=3)
...
plt.tight_layout()
plt.ylim(0.00001, 0.001)
plt.savefig("differential_cross_section_pt_lepton_2_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(eta_lepton_1_bins_signal_0, dsigma_signal_eta_lepton_1_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(eta_lepton_1_bins_signal_2, dsigma_signal_eta_lepton_1_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(eta_lepton_1_bins_background, dsigma_background_eta_lepton_1, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($W^+ W^-$)", color="blue", linewidth=3)
...
plt.savefig("differential_cross_section_eta_lepton_1_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
...
plt.step(eta_lepton_2_bins_signal_0, dsigma_signal_eta_lepton_2_0, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_0} / \Lambda^4$]", color="red", linewidth=3)
plt.step(eta_lepton_2_bins_signal_2, dsigma_signal_eta_lepton_2_2, where="mid", alpha=0.7, label="LHC@13 TeV : Signal ($W^+ W^-$) [$f_{M_2} / \Lambda^4$]", color="green", linewidth=3)
plt.step(eta_lepton_2_bins_background, dsigma_background_eta_lepton_2, where="mid", alpha=0.7, label="LHC@13 TeV : SM background ($W^+ W^-$)", color="blue", linewidth=3)
...
plt.tight_layout()
plt.ylim(0.0005, 0.05)
plt.savefig("differential_cross_section_eta_lepton_2_fully_leptonic_LHC.pdf", dpi=600)
plt.show()
