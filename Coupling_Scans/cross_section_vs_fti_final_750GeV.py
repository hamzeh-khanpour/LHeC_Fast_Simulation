...
file_names = {
    "FT0": "cross_sections_FT0_750GeV.txt",
    "FT1": "cross_sections_FT1_750GeV.txt",
    "FT2": "cross_sections_FT2_750GeV.txt",
#    "FM3": "cross_sections_FM3_750GeV.txt"
}
labels = {
    "FT0": "$F_{T_0} / \Lambda^4$ (LHeC@0.750 TeV)",
    "FT1": "$F_{T_1} / \Lambda^4$ (LHeC@0.750 TeV)",
    "FT2": "$F_{T_2} / \Lambda^4$ (LHeC@0.750 TeV)",
...
plt.xlabel('Coupling Values: $f_{T_i} / \Lambda^4$ (TeV$^{-4}$)', fontsize=16)
...
# Save the plot
plt.savefig('cross_section_vs_FTI_coupling_750GeV.pdf', dpi=300)
plt.show()
