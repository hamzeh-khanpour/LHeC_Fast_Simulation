...
background_file_1 = "/home/hamzeh-khanpour/MG5_aMC_v3_5_7/aa_ttbar_fully_leptonic/Events/run_01/aa_ttbar_fully_leptonic.lhe"
...
(pt_leptons_background_1, eta_leptons_background_1, delta_r_background_1, met_background_1,
 rapidity_lepton_pair_background_1, invariant_mass_lepton_pair_background_1, pt_lepton_pair_background_1,
 pt_lepton_1_background_1, pt_lepton_2_background_1, eta_lepton_1_background_1, eta_lepton_2_background_1) = parse_lhe_file(background_file_1)
...
min_len_background_1 = min_length(pt_lepton_1_background_1, pt_lepton_2_background_1, eta_leptons_background_1,
                                  eta_lepton_1_background_1, eta_lepton_2_background_1,
                                  delta_r_background_1, met_background_1, rapidity_lepton_pair_background_1,
                                  invariant_mass_lepton_pair_background_1, pt_lepton_pair_background_1)
...
df_background_ttbar = pd.DataFrame({
    'pt_lepton_1': pt_lepton_1_background_1[:min_len_background_1],
    'pt_lepton_2': pt_lepton_2_background_1[:min_len_background_1],
    'eta_lepton_1': eta_lepton_1_background_1[:min_len_background_1],
    'eta_lepton_2': eta_lepton_2_background_1[:min_len_background_1],
    'delta_R': delta_r_background_1[:min_len_background_1],
    'MET': met_background_1[:min_len_background_1],
    'rapidity_lepton_pair': rapidity_lepton_pair_background_1[:min_len_background_1],
    'M_ll': invariant_mass_lepton_pair_background_1[:min_len_background_1],
    'pt_ll': pt_lepton_pair_background_1[:min_len_background_1],
    'label': 0  # Background label
})
...
df = pd.concat([df_signal_0, df_signal_2, df_background, df_background_ttbar], ignore_index=True)
...
# ttbar
background_ttbar_cross_section = 2.3846e-06  # pb
...
pt_bins_ttbar, dsigma_ttbar_pt = calculate_dsigma(pt_leptons_background_1, background_ttbar_cross_section, bin_width_pt_lepton, pt_range_lepton)
...
eta_bins_ttbar, dsigma_ttbar_eta = calculate_dsigma(eta_leptons_background_1, background_ttbar_cross_section, bin_width_eta, eta_range)
...
delta_r_bins_ttbar, dsigma_ttbar_delta_r = calculate_dsigma(delta_r_background_1, background_ttbar_cross_section, bin_width_delta_r, delta_r_range)
...
met_bins_ttbar, dsigma_ttbar_met = calculate_dsigma(met_background_1, background_ttbar_cross_section, bin_width_met, met_range)


# Rapidity of lepton pair
...
rapidity_bins_ttbar, dsigma_ttbar_rapidity = calculate_dsigma(rapidity_lepton_pair_background_1, background_ttbar_cross_section, bin_width_rapidity, rapidity_range)
...
m_ll_bins_ttbar, dsigma_ttbar_m_ll = calculate_dsigma(invariant_mass_lepton_pair_background_1, background_ttbar_cross_section, bin_width_m_ll, m_ll_range)
...
pt_ll_bins_ttbar, dsigma_ttbar_pt_ll = calculate_dsigma(pt_lepton_pair_background_1, background_ttbar_cross_section, bin_width_pt_ll, pt_ll_range)
...
pt_lepton_1_bins_ttbar, dsigma_ttbar_pt_lepton_1 = calculate_dsigma(pt_lepton_1_background_1, background_ttbar_cross_section, bin_width_pt_lepton_1, pt_lepton_1_range)
...
pt_lepton_2_bins_ttbar, dsigma_ttbar_pt_lepton_2 = calculate_dsigma(pt_lepton_2_background_1, background_ttbar_cross_section, bin_width_pt_lepton_2, pt_lepton_2_range)
...
eta_lepton_1_bins_ttbar, dsigma_ttbar_eta_lepton_1 = calculate_dsigma(eta_lepton_1_background_1, background_ttbar_cross_section, bin_width_eta_lepton_1, eta_lepton_1_range)
...
eta_lepton_2_bins_ttbar, dsigma_ttbar_eta_lepton_2 = calculate_dsigma(eta_lepton_2_background_1, background_ttbar_cross_section, bin_width_eta_lepton_2, eta_lepton_2_range)
...
plt.step(pt_bins_ttbar, dsigma_ttbar_pt, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(eta_bins_ttbar, dsigma_ttbar_eta, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(delta_r_bins_ttbar, dsigma_ttbar_delta_r, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(met_bins_ttbar, dsigma_ttbar_met, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(rapidity_bins_ttbar, dsigma_ttbar_rapidity, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(m_ll_bins_ttbar, dsigma_ttbar_m_ll, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(pt_ll_bins_ttbar, dsigma_ttbar_pt_ll, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(pt_lepton_1_bins_ttbar, dsigma_ttbar_pt_lepton_1, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(pt_lepton_2_bins_ttbar, dsigma_ttbar_pt_lepton_2, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(eta_lepton_1_bins_ttbar, dsigma_ttbar_eta_lepton_1, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
...
plt.step(eta_lepton_2_bins_ttbar, dsigma_ttbar_eta_lepton_2, where="mid", alpha=0.7, label=r"LHeC@1.2 TeV : SM background ($t\bar{t}$)", color="purple", linewidth=3)
