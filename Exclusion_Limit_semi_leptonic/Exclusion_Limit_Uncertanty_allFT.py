...
plt.axvline(F_i_upper, color='g', linestyle='--', label=r'Upper $(f_{T_0} / \Lambda^4)^{\text{lim}}$', linewidth=3)
plt.axvline(F_i_lower, color='g', linestyle='--', label=r'Lower $(f_{T_0} / \Lambda^4)^{\text{lim}}$', linewidth=3)
