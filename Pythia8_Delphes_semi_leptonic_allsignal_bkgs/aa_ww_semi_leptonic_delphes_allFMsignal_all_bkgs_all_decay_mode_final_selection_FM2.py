...
#100
signal_cross_sections = {
    "$FM_{0} / \Lambda^4$": 0.01490778,   # pb
    "$FM_{1} / \Lambda^4$": 0.01508460,   # pb
    "FM2_Lambda4": 0.0214318,             # pb
    "$FM_{3} / \Lambda^4$": 0.0164548     # pb
}


aa_ww_background_cross_section = 0.0149124 # aa_ww_semi_leptonic_SM_NP_0_FMi_0


aa_ttbar_background_cross_section  = 4.824851e-05 * 100.0  # pb  * 10^{+2}
aa_tautau_background_cross_section = 14.46100  # pb
aa_mumu_background_cross_section   = 15.77700  # pb


inclusive_ttbar_background_cross_section   = 0.00817729           # pb
single_top_background_cross_section        = 1.36209000           # pb

w_production_background_cross_section      = 2.68341400           # pb
z_production_background_cross_section      = 0.35079000           # pb


wwj_production_background_cross_section      = 0.02033281625797406   # pb
zzj_production_background_cross_section      = 8.098369938127394e-05 * 100.0  # pb  * 10^{+2}
wzj_production_background_cross_section      = 0.002858915860372209  # pb


num_bins = 50
pt_range_lepton = (0, 400)     # Range for lepton pT
pt_range_jet = (0, 400)        # Range for leading jet pT (adjusted for higher jet momenta)
eta_range = (-4, 6)          # Range for pseudorapidity
delta_r_range = (0, 9)        # Range for Delta R
