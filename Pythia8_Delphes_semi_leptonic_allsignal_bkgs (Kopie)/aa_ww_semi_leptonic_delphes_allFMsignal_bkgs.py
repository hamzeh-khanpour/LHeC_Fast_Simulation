...
aa_ww_background_file_path = "aa_ww_semi_leptonic_SM.root"

aa_ttbar_background_file_path  = "aa_ttbar_semi_leptonic.root"
aa_tautau_background_file_path = "aa_tautau_semi_leptonic.root"
aa_mumu_background_file_path   = "aa_mumu.root"



inclusive_ttbar_background_file_path   = "inclusive_ttbar_semi_leptonic.root"
single_top_background_file_path        = "single_top_semi_leptonic.root"
w_production_background_file_path      = "w_production_semi_leptonic.root"
z_production_background_file_path      = "z_production_semi_leptonic.root"
...
def process_file(
    ...
    for entry in range(numberOfEntries):
        ...
        if hist_centrality is not None and hist_exp_centrality is not None:
            ...
            if delta_eta_jj > 0:
                centrality = jets[1].Eta()
                hist_centrality.Fill(centrality)
                hist_exp_centrality.Fill(jets[0].Eta())
...
aa_ww_background_cross_section = 0.01507430  # pb


aa_ttbar_background_cross_section  = 1.43086e-05 * 100.0  # pb  * 10^{+2}
aa_tautau_background_cross_section = 2.51510000  # pb
aa_mumu_background_cross_section   = 2.57270000  # pb


inclusive_ttbar_background_cross_section   = 0.0024672           # pb
single_top_background_cross_section        = 1.0215              # pb
w_production_background_cross_section      = 0.47776399999999997  # pb
z_production_background_cross_section      = 0.172807009599      # pb
...
hist_centrality_aa_ww = ROOT.TH1F("hist_centrality_aa_ww", "Centrality (aa_ww); Centrality; Entries", num_bins, *centrality_range)
hist_exp_centrality_aa_ww = ROOT.TH1F("hist_exp_centrality_aa_ww", "Exp Centrality (aa_ww); exp(Centrality); Entries", num_bins, *exp_centrality_range)
...
hist_centrality_aa_ttbar = ROOT.TH1F("hist_centrality_aa_ttbar", "Centrality (aa_ttbar); Centrality; Entries", num_bins, *centrality_range)
hist_exp_centrality_aa_ttbar = ROOT.TH1F("hist_exp_centrality_aa_ttbar", "Exp Centrality (aa_ttbar); exp(Centrality); Entries", num_bins, *exp_centrality_range)
...
hist_centrality_aa_tautau = ROOT.TH1F("hist_centrality_aa_tautau", "Centrality (aa_tautau); Centrality; Entries", num_bins, *centrality_range)
hist_exp_centrality_aa_tautau = ROOT.TH1F("hist_exp_centrality_aa_tautau", "Exp Centrality (aa_tautau); exp(Centrality); Entries", num_bins, *exp_centrality_range)
...
hist_centrality_aa_mumu = ROOT.TH1F("hist_centrality_aa_mumu", "Centrality (aa_mumu); Centrality; Entries", num_bins, *centrality_range)
hist_exp_centrality_aa_mumu = ROOT.TH1F("hist_exp_centrality_aa_mumu", "Exp Centrality (aa_mumu); exp(Centrality); Entries", num_bins, *exp_centrality_range)
...
hist_centrality_inclusive_ttbar = ROOT.TH1F("hist_centrality_inclusive_ttbar", "Centrality (inclusive_ttbar); Centrality; Entries", num_bins, *centrality_range)
hist_exp_centrality_inclusive_ttbar = ROOT.TH1F("hist_exp_centrality_inclusive_ttbar", "Exp Centrality (inclusive_ttbar); exp(Centrality); Entries", num_bins, *exp_centrality_range)
...
hist_centrality_single_top = ROOT.TH1F("hist_centrality_single_top", "Centrality (single_top); Centrality; Entries", num_bins, *centrality_range)
hist_exp_centrality_single_top = ROOT.TH1F("hist_exp_centrality_single_top", "Exp Centrality (single_top); exp(Centrality); Entries", num_bins, *exp_centrality_range)
...
hist_centrality_w_production = ROOT.TH1F("hist_centrality_w_production", "Centrality (w_production); Centrality; Entries", num_bins, *centrality_range)
hist_exp_centrality_w_production = ROOT.TH1F("hist_exp_centrality_w_production", "Exp Centrality (w_production); exp(Centrality); Entries", num_bins, *exp_centrality_range)
...
hist_centrality_z_production = ROOT.TH1F("hist_centrality_z_production", "Centrality (z_production); Centrality; Entries", num_bins, *centrality_range)
hist_exp_centrality_z_production = ROOT.TH1F("hist_exp_centrality_z_production", "Exp Centrality (z_production); exp(Centrality); Entries", num_bins, *exp_centrality_range)
...
(hist_lepton_aa_ww, hist_leading_jet_aa_ww, hist_lepton_eta_aa_ww, hist_delta_r_aa_ww,
 hist_missing_et_aa_ww, hist_centrality_aa_ww, hist_exp_centrality_aa_ww, hist_jet_centrality_aa_ww,
 ...
 background_efficiency_pre_aa_ww, background_efficiency_final_aa_ww) = process_file(
    ...
    hist_delta_r_aa_ww, hist_missing_et_aa_ww, hist_centrality_aa_ww, hist_exp_centrality_aa_ww,
...
(hist_lepton_aa_ttbar, hist_leading_jet_aa_ttbar, hist_lepton_eta_aa_ttbar, hist_delta_r_aa_ttbar,
 hist_missing_et_aa_ttbar, hist_centrality_aa_ttbar, hist_exp_centrality_aa_ttbar, hist_jet_centrality_aa_ttbar,
 ...
 background_efficiency_pre_aa_ttbar, background_efficiency_final_aa_ttbar) = process_file(
    ...
    hist_delta_r_aa_ttbar, hist_missing_et_aa_ttbar, hist_centrality_aa_ttbar, hist_exp_centrality_aa_ttbar,
...
(hist_lepton_aa_tautau, hist_leading_jet_aa_tautau, hist_lepton_eta_aa_tautau, hist_delta_r_aa_tautau,
 hist_missing_et_aa_tautau, hist_centrality_aa_tautau, hist_exp_centrality_aa_tautau, hist_jet_centrality_aa_tautau,
 ...
 background_efficiency_pre_aa_tautau, background_efficiency_final_aa_tautau) = process_file(
    ...
    hist_delta_r_aa_tautau, hist_missing_et_aa_tautau, hist_centrality_aa_tautau, hist_exp_centrality_aa_tautau,
...
(hist_lepton_aa_mumu, hist_leading_jet_aa_mumu, hist_lepton_eta_aa_mumu, hist_delta_r_aa_mumu,
 hist_missing_et_aa_mumu, hist_centrality_aa_mumu, hist_exp_centrality_aa_mumu, hist_jet_centrality_aa_mumu,
 ...
 background_efficiency_pre_aa_mumu, background_efficiency_final_aa_mumu) = process_file(
    ...
    hist_delta_r_aa_mumu, hist_missing_et_aa_mumu, hist_centrality_aa_mumu, hist_exp_centrality_aa_mumu,
...
(hist_lepton_inclusive_ttbar, hist_leading_jet_inclusive_ttbar, hist_lepton_eta_inclusive_ttbar, hist_delta_r_inclusive_ttbar,
 hist_missing_et_inclusive_ttbar, hist_centrality_inclusive_ttbar, hist_exp_centrality_inclusive_ttbar, hist_jet_centrality_inclusive_ttbar,
 ...
 background_efficiency_pre_inclusive_ttbar, background_efficiency_final_inclusive_ttbar) = process_file(
    ...
    hist_delta_r_inclusive_ttbar, hist_missing_et_inclusive_ttbar, hist_centrality_inclusive_ttbar, hist_exp_centrality_inclusive_ttbar,
...
(hist_lepton_single_top, hist_leading_jet_single_top, hist_lepton_eta_single_top, hist_delta_r_single_top,
 hist_missing_et_single_top, hist_centrality_single_top, hist_exp_centrality_single_top, hist_jet_centrality_single_top,
 ...
 background_efficiency_pre_single_top, background_efficiency_final_single_top) = process_file(
    ...
    hist_delta_r_single_top, hist_missing_et_single_top, hist_centrality_single_top, hist_exp_centrality_single_top,
...
(hist_lepton_w_production, hist_leading_jet_w_production, hist_lepton_eta_w_production, hist_delta_r_w_production,
 hist_missing_et_w_production, hist_centrality_w_production, hist_exp_centrality_w_production, hist_jet_centrality_w_production,
 ...
 background_efficiency_pre_w_production, background_efficiency_final_w_production) = process_file(
    ...
    hist_delta_r_w_production, hist_missing_et_w_production, hist_centrality_w_production, hist_exp_centrality_w_production,
...
(hist_lepton_z_production, hist_leading_jet_z_production, hist_lepton_eta_z_production, hist_delta_r_z_production,
 hist_missing_et_z_production, hist_centrality_z_production, hist_exp_centrality_z_production, hist_jet_centrality_z_production,
 ...
 background_efficiency_pre_z_production, background_efficiency_final_z_production) = process_file(
    ...
    hist_delta_r_z_production, hist_missing_et_z_production, hist_centrality_z_production, hist_exp_centrality_z_production,
...
background_dsigma_aa_ww = {
    ...
    "centrality_bins": calculate_dsigma(hist_centrality_aa_ww, aa_ww_background_cross_section, bin_width_centrality),
    "exp_centrality_bins": calculate_dsigma(hist_exp_centrality_aa_ww, aa_ww_background_cross_section, bin_width_exp_centrality),
...
background_dsigma_aa_ttbar = {
    ...
    "centrality_bins": calculate_dsigma(hist_centrality_aa_ttbar, aa_ttbar_background_cross_section, bin_width_centrality),
    "exp_centrality_bins": calculate_dsigma(hist_exp_centrality_aa_ttbar, aa_ttbar_background_cross_section, bin_width_exp_centrality),
...
background_dsigma_aa_tautau = {
    ...
    "centrality_bins": calculate_dsigma(hist_centrality_aa_tautau, aa_tautau_background_cross_section, bin_width_centrality),
    "exp_centrality_bins": calculate_dsigma(hist_exp_centrality_aa_tautau, aa_tautau_background_cross_section, bin_width_exp_centrality),
...
background_dsigma_aa_mumu = {
    ...
    "centrality_bins": calculate_dsigma(hist_centrality_aa_mumu, aa_mumu_background_cross_section, bin_width_centrality),
    "exp_centrality_bins": calculate_dsigma(hist_exp_centrality_aa_mumu, aa_mumu_background_cross_section, bin_width_exp_centrality),
...
background_dsigma_inclusive_ttbar = {
    ...
    "centrality_bins": calculate_dsigma(hist_centrality_inclusive_ttbar, inclusive_ttbar_background_cross_section, bin_width_centrality),
    "exp_centrality_bins": calculate_dsigma(hist_exp_centrality_inclusive_ttbar, inclusive_ttbar_background_cross_section, bin_width_exp_centrality),
...
background_dsigma_single_top = {
    ...
    "centrality_bins": calculate_dsigma(hist_centrality_single_top, single_top_background_cross_section, bin_width_centrality),
    "exp_centrality_bins": calculate_dsigma(hist_exp_centrality_single_top, single_top_background_cross_section, bin_width_exp_centrality),
...
background_dsigma_w_production = {
    ...
    "centrality_bins": calculate_dsigma(hist_centrality_w_production, w_production_background_cross_section, bin_width_centrality),
    "exp_centrality_bins": calculate_dsigma(hist_exp_centrality_w_production, w_production_background_cross_section, bin_width_exp_centrality),
...
background_dsigma_z_production = {
    ...
    "centrality_bins": calculate_dsigma(hist_centrality_z_production, z_production_background_cross_section, bin_width_centrality),
    "exp_centrality_bins": calculate_dsigma(hist_exp_centrality_z_production, z_production_background_cross_section, bin_width_exp_centrality),
...
plt.tight_layout()
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/differential_cross_section_lepton_pt_allFMsignal_allbkgs.pdf", dpi=600)
...
# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/differential_cross_section_jet_pt_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
...
# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/differential_cross_section_lepton_eta_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
...
# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/differential_cross_section_delta_r_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
...
# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/differential_cross_section_met_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
...
# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/normalized_m_w_hadronic_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
...
# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/normalized_m_w_leptonic_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
...
# ===================================================
# ✅ Normalized Centrality Distribution (Semi-Leptonic)
# ===================================================
...
# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/normalized_eta_leading_jet_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
...
# ===================================================
# ✅ Normalized Exponential Centrality Distribution (Semi-Leptonic)
# ===================================================
...
# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/normalized_eta_subleading_jet_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
...
plt.text(0.2, 0.25, r"$C_{\mathrm{jets}} = \frac{|\eta_{\mathrm{jet1}} + \eta_{\mathrm{jet2}}|}{2}$", color="black")
plt.tight_layout()

# ✅ Save and Show
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_semi_leptonic_allsignal_bkgs/normalized_jet_centrality_allFMsignal_allbkgs.pdf", dpi=600)
plt.show()
