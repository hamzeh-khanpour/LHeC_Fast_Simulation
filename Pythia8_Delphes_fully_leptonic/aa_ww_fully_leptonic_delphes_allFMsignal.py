...
# ✅ Background histograms for fully leptonic analysis
...
(hist_leading_lepton_background, hist_subleading_lepton_background, hist_m_ll_background,
 ...
 hist_subleading_lepton_eta_background, background_efficiency_pre, background_efficiency_final) = process_file(
    background_file_path, hist_leading_lepton_background, hist_subleading_lepton_background, hist_m_ll_background,
    hist_pt_ll_background, hist_rapidity_ll_background, hist_lepton_separation_background,
    hist_azimuthal_angle_separation_background, hist_rapidity_difference_background, hist_met_background,
    hist_mT_W_background, hist_m_WW_background, hist_pT_WW_background, hist_leading_lepton_eta_background,
...
background_dsigma = {
    # ✅ Leading & Subleading Lepton Kinematics
    "pt_bins_leading_lepton": calculate_dsigma(hist_leading_lepton_background, background_cross_section, bin_width_pt_leading_lepton),
    "pt_bins_subleading_lepton": calculate_dsigma(hist_subleading_lepton_background, background_cross_section, bin_width_pt_subleading_lepton),
    "eta_bins_leading_lepton": calculate_dsigma(hist_leading_lepton_eta_background, background_cross_section, bin_width_eta_leading_lepton),
    "eta_bins_subleading_lepton": calculate_dsigma(hist_subleading_lepton_eta_background, background_cross_section, bin_width_eta_subleading_lepton),

    # ✅ Dilepton System Kinematics
    "m_ll_bins": calculate_dsigma(hist_m_ll_background, background_cross_section, bin_width_m_ll),
    "pt_ll_bins": calculate_dsigma(hist_pt_ll_background, background_cross_section, bin_width_pt_ll),
    "rapidity_ll_bins": calculate_dsigma(hist_rapidity_ll_background, background_cross_section, bin_width_rapidity_ll),

    # ✅ Angular Separations
    "delta_r_bins": calculate_dsigma(hist_lepton_separation_background, background_cross_section, bin_width_delta_r),
    "delta_phi_bins": calculate_dsigma(hist_azimuthal_angle_separation_background, background_cross_section, bin_width_delta_phi),
    "delta_y_bins": calculate_dsigma(hist_rapidity_difference_background, background_cross_section, bin_width_delta_y),

    # ✅ Missing Transverse Energy
    "met_bins": calculate_dsigma(hist_met_background, background_cross_section, bin_width_met),

    # ✅ W Boson & Diboson System
    "mT_W_bins": calculate_dsigma(hist_mT_W_background, background_cross_section, bin_width_mT_W),
    "m_WW_bins": calculate_dsigma(hist_m_WW_background, background_cross_section, bin_width_m_WW),
    "pT_WW_bins": calculate_dsigma(hist_pT_WW_background, background_cross_section, bin_width_pT_WW),
}
...
# Save the plot
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_fully_leptonic/differential_cross_section_deltaPhi_ll_allFMsignal.pdf", dpi=600)
...
# Save the plot
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_fully_leptonic/differential_cross_section_deltaY_ll_allFMsignal.pdf", dpi=600)
...
# Save the plot
plt.savefig("/home/hamzeh-khanpour/Documents/GitHub/LHeC_Fast_Simulation/Pythia8_Delphes_fully_leptonic/differential_cross_section_m_WW_allFMsignal.pdf", dpi=600)
